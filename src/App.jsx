...
function hatchMaterial() {
  ...
  material.fragmentShader = material.fragmentShader.replace("float second=dotted(lineMask(pixel,secondNormal,secondTangent,shade),pixel,secondTangent,sharedTerminal);", "float second=lineMask(pixel,secondNormal,secondTangent,shade,secondaryThreshold,secondaryThreshold,1.12);");
