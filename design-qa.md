...
- [Resolved P1] The default preset is now Greek bust and the default outline thickness is 0.5 px. Added a `Raggedness` control (0–100%) that applies deterministic, screen-space wear to hatch strokes in both the live shader and SVG paths, preserving clean lines at 0% and introducing aged, broken texture as it increases.
